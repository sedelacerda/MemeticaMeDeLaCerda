...
namespace MemeticaMeDeLaCerda
{
	...
	public class ToDoBroadcastReceiver : GcmBroadcastReceiverBase<PushHandlerService>
	{
		...
		public static string[] senderIDs = new string[] { "771808715483" };
	}
	...
	public class PushHandlerService : GcmServiceBase
	{
		...
		protected override void OnRegistered(Context context, string registrationId)
		{
			...
			MobileServiceClient client = ChatActivity.CurrentActivity.CurrentClient;           
			...
			try
			{
				...
				ChatActivity.CurrentActivity.RunOnUiThread(
			...
			if (intent.Extras.ContainsKey("message"))
			{
				...
				PendingIntent contentIntent = 
					PendingIntent.GetActivity(context, 0, 
						new Intent(this, typeof(ChatActivity)), 0);           
